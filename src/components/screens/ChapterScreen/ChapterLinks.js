...
const buildTwitterUrl = (guide, text) =>
  `https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Fplaybook.fidisys.com%2F&ref_src=twsrc%5Etfw&text=${encodeURI(
    text
  )}&tw_p=tweetbutton&url=https%3A%2F%2Fplaybook.fidisys.com%2F${guide}&via=fidisysInc`;
      ...
      {twitterShareText && (
        <BoxLink to={buildTwitterUrl(guide, twitterShareText)}>
          <BoxLinkContent>
            ...
            <BoxLinkMessage>
              Is this free guide helping you? Tweet to give kudos and help other startups find it.
            </BoxLinkMessage>
          </BoxLinkContent>
        </BoxLink>
      )}
